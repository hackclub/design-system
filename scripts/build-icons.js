...
// Adapted from https://github.com/jxnblk/microicon/blob/master/build.js
...
const getContents = dir => filename =>
...
const mdFlattened = Object.keys(mdPaths)
  .reduce((a, key, i) => {
...
fs.writeFileSync('icons.js', mdJs)

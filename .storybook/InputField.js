      ...
      <Box width={500} pr={3}>
        ...
        <InputController>
          <InputField onChange={() => {}}>
            ...
            <Icon name="feedback" />
            <Input id="form-field" placeholder="How did we do?" />
            <Icon name="send" />
          </InputField>
        </InputController>
      </Box>
        ...
        <Flex width={900}>
          <Box width={1 / 2} pl={3}>
            ...
            <InputField color="red" onChange={() => {}}>
              ...
              <Input id="form-field-3" defaultValue="oliver@example.com" />
...
class InputController extends React.PureComponent {
  ...
  render() {
    return React.cloneElement(React.Children.only(this.props.children), {
      ...
      info: !this.state.isValid && this.state.isDirty ? 'Wrong' : null,
      ...this.state
    })
  }
}
